...
**ВАЖНО:** Подробные правила тестирования см. в `.opencode/rules/tdd.md`
...
**Примечание:** Интеграционные тесты ViewModels не создаются (см. `.opencode/rules/tdd.md`). ViewModel тестируется через unit-тесты с MockK.
...
- Маршруты в `navigation/Screen.kt`, навигация в `ui/screens/common/RootScreenComponents.kt`, factory методы
