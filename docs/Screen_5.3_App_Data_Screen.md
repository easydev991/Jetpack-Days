...
- ✅ **Экран 5.1 реализован**: More Screen уже создан (`app/src/main/java/com/dayscounter/ui/screens/more/MoreScreen.kt`)
...
2. Создать отдельный файл `AppDataScreen.kt` в `ui/screens/appdata/`
...
- ⏳ Файл `AppDataScreen.kt` создан в `ui/screens/appdata/`
