...
- ⚠️ **Требуется Экран 5.1**: More Screen — находится в разработке (есть заглушка в `ui/screens/root/RootScreenComponents.kt`), требуется полная реализация для навигации к ThemeIcon Screen
