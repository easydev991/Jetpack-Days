...
class ItemRepositoryIntegrationTest {
    ...
    fun `fullCycle_createReadUpdateDelete_thenWorksCorrectly`() = runBlocking {
        ...
        // When - Update
        val updatedItem = retrieved!!.copy(
    ...
    @Test
    fun `searchItems_whenMultipleItems_thenReturnsMatchingItems`() = runBlocking {
        // Given
    ...
    @Test
    fun `getAllItems_thenReturnsAllItemsSorted`() = runBlocking {
        // Given
    ...
    @Test
    fun `getItemsCount_whenItemsExist_thenReturnsCorrectCount`() = runBlocking {
        // Given
        repository.insertItem(Item(title = "Событие 1", timestamp = 1000000000000L))
        repository.insertItem(Item(title = "Событие 2", timestamp = 2000000000000L))
    ...
    @Test
    fun `conversionBetweenEntityAndDomain_preservesAllFields`() = runBlocking {
        // Given
        val originalItem = Item(
            id = 0L, // Будет автогенерирован
    ...
    @Test
    fun `conversionWithNullColorTag_preservesNull`() = runBlocking {
        // Given
        val item = Item(
