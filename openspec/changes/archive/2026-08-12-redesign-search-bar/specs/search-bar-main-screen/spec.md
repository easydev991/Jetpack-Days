# Spec: search-bar-main-screen

Поле поиска `SearchField` на главном экране `MainScreen` приложения JetpackDays. Реализовано через `SearchBar` из material3 1.4.0. Поле показывается только когда в списке ≥5 элементов, либо когда пользователь начал вводить поисковый запрос. Анимировано плавным появлением и сворачиванием.
