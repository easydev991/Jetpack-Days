# Event Sort Stability

## Purpose

Ensure consistent and deterministic ordering of events when multiple events share the same date, preventing random shuffle on recomposition.
